...
from agent.memory import get_or_create_conversation, load_recent_messages, save_message
...
def _build_graph():
    ...
    graph.add_node("load_tool_context", _load_tool_context)
...
def run_agent(
    *,
    ...
    result: AgentState = get_agent_graph().invoke(initial_state)
